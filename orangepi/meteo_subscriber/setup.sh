...
# Variables
PROJECT_DIR="/home/<your_user>/dafer-embedded/orangepi/meteo_subscriber"
...
sudo -u <your_user> bash -c "source /path/to/venv/bin/activate && pip install -r requirements.txt"
...
echo "  http://<ORANGE_PI_IP>:8080/meteo"
echo ""
